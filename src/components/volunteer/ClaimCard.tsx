...
// it behind a disclosure isn't security (the data is already in the response);
// it's so the address of the child you are NOT looking at isn't sitting open on
      ...
      <details open={defaultOpen} className="group">
        <summary className="flex cursor-pointer flex-wrap items-center gap-2 p-4 marker:content-none">
          ...
          {/* The affordance only. aria-hidden because <summary> already
              announces its own expanded state — visible text saying "expand"
              would be read out as well, contradicting it once open. */}
          <span
            aria-hidden="true"
